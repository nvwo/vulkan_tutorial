...
void HelloTriangleApplication::updateAppState()
{
}

void HelloTriangleApplication::submitDrawCommands()
{
}
...
void HelloTriangleApplication::createLogicalDevice()
{
	...
	//queueCreateInfo.queueFamilyIndex = indices.graphicsFamily; //indices.graphicsFamily.value();
...
void HelloTriangleApplication::createRenderPass() {
	...
	colorAttachment.samples = msaaSamples;// VK_SAMPLE_COUNT_1_BIT;
...
void HelloTriangleApplication::createCommandBuffers() {
	...
	for (size_t i = 0; i < commandBuffers.size(); i++) {
		...
		vkCmdBindIndexBuffer(commandBuffers[i], indexBuffer, 0, VK_INDEX_TYPE_UINT32);// VK_INDEX_TYPE_UINT16
...
void HelloTriangleApplication::createTextureImage() {
	int texWidth, texHeight, texChannels;//"textures/texture.jpg"
	...
	//transitionImageLayout(textureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_LAYOUT_PREINITIALIZED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, mipLevels);//:VK_IMAGE_LAYOUT_UNDEFINED
...
void HelloTriangleApplication::createDepthResources() {
	...
	createImage(swapChainExtent.width, swapChainExtent.height, 1, msaaSamples, depthFormat,//VK_SAMPLE_COUNT_1_BIT
